...
public class FormUploadDemo {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, JSONException {
    ...
    private static void testAsync() throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, JSONException {
        //uploader
        FormUploader uploader = new FormUploader(BUCKET_NAME, OPERATOR_NAME, OPERATOR_PWD);
