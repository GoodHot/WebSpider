package com.goodHot.fun.util.upyun.demo;

import com.goodHot.fun.util.upyun.com.upyun.MediaHandler;
import com.goodHot.fun.util.upyun.com.upyun.Result;
...
public class MediaHandlerDemo {
    //     运行前先设置好以下三个参数
    private static final String BUCKET_NAME = "jiemen-vedio-upyun.b0.aicdn.com";
    private static final String OPERATOR_NAME = "wang22";
    private static final String OPERATOR_PWD = "111111hhhhhh";
     ...
     * @return TaskId 数组
     */
    private static String[] testMediaProcess() throws JSONException {
        ...
        //需要处理视频路径
        paramsMap.put(MediaHandler.Params.SOURCE, "/Users/yanwenyuan/Downloads/java-sdk-master/test.mp4");
