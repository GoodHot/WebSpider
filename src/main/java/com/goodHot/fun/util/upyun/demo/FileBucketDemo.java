...
public class FileBucketDemo {
    ...
    // 运行前先设置好以下三个参数
    private static final String BUCKET_NAME = "jiemen-vedio-upyun";
...
//    private static final String SAMPLE_TXT_FILE = System.getProperty("user.dir") + "/test.txt";
    private static final String SAMPLE_TXT_FILE = "/Users/yanwenyuan/Downloads/java-sdk-master/test.mp4";
...
//        System.out.println(filePath + " 的文件内容:" + datas);
        System.out.println("直接读取文件内容，返回值是String");
