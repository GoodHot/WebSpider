...
import com.goodHot.fun.util.upyun.com.upyun.CompressHandler;
...
//        testDecompress();
    ...
    private static void testDecompress() throws JSONException {
    ...
    private static void testCompress() throws JSONException {
